...
def main():
    ...
    train_ds = load_dataset("fmt_videos_train", "train.csv", train_opts['batch_size'], num_frames, train_opts['use_compressed_data'], 1)
    test_ds = load_dataset("fmt_videos_test", "test.csv",  train_opts['batch_size'], num_frames, train_opts['use_compressed_data'], 1)
