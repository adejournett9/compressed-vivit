'''
This code takes inspiration from training scripts in teh CS78 Deep Learning course at dartmouth
...
def eval(model, device, val_ds, batch_size):
    val_dl = DataLoader(val_ds, batch_size=batch_size, shuffle=True, num_workers=8, collate_fn=collate)
    ...
    return val_loss, val_acc / len(val_ds.paths)
